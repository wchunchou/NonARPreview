...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nconst React = __webpack_require__(/*! react */ \"react\");\nconst framer_1 = __webpack_require__(/*! framer */ \"framer\");\nconst styled_components_1 = __webpack_require__(/*! styled-components */ \"./node_modules/styled-components/dist/styled-components.browser.esm.js\");\nconst Wrap = styled_components_1.default.div ``;\nconst Video = styled_components_1.default.video `\n  width: 100%;\n  height: 100%;\n  object-fit: cover;\n  object-position: '50% 50%';\n`;\nvar SrcType;\n(function (SrcType) {\n    SrcType[\"Video\"] = \"Video\";\n    SrcType[\"Url\"] = \"URL\";\n})(SrcType || (SrcType = {}));\nclass HTML_Video extends React.Component {\n    play(myVideo) {\n        window[\"__checkBudget__\"]();\n        myVideo.play();\n    }\n    pause(myVideo) {\n        window[\"__checkBudget__\"]();\n        myVideo.pause();\n    }\n    stop(myVideo) {\n        window[\"__checkBudget__\"]();\n        myVideo.load();\n    }\n    componentWillReceiveProps(nextProps) {\n        window[\"__checkBudget__\"]();\n        if (this.props.playerState != nextProps.playerState) {\n            var myVideo = document.getElementById('video1');\n            switch (nextProps.playerState) {\n                case 'play':\n                    this.play(myVideo);\n                    break;\n                case 'pause':\n                    this.pause(myVideo);\n                    break;\n                case 'stop':\n                    this.stop(myVideo);\n                    break;\n                default:\n                    break;\n            }\n        }\n    }\n    render() {\n        window[\"__checkBudget__\"]();\n        const { width, height, autoplay, controls, loop, muted, srcType, url, video, } = this.props;\n        return (React.createElement(Wrap, { style: {\n                width: width,\n                height: height,\n            } },\n            React.createElement(Video, { id: \"video1\", autoplay: autoplay, controls: controls, loop: loop, muted: muted },\n                React.createElement(\"source\", { src: srcType === SrcType.Url ? url : video }))));\n    }\n}\n// Set default properties\nHTML_Video.defaultProps = {\n    srcType: SrcType.Url,\n    url: 'https://www.w3schools.com/html/mov_bbb.mp4',\n    video: '',\n    width: 375,\n    height: 206,\n    autoplay: false,\n    controls: false,\n    loop: true,\n    muted: true,\n};\n// Items shown in property panel\nHTML_Video.propertyControls = {\n    srcType: {\n        type: framer_1.ControlType.SegmentedEnum,\n        title: 'Source',\n        options: [SrcType.Url, SrcType.Video],\n    },\n    url: {\n        type: framer_1.ControlType.String,\n        title: ' ',\n        placeholder: '.../example.mp4',\n        hidden(props) {\n            window[\"__checkBudget__\"]();\n            return props.srcType === SrcType.Video;\n        },\n    },\n    video: {\n        type: framer_1.ControlType.File,\n        title: ' ',\n        allowedFileTypes: ['mp4'],\n        hidden(props) {\n            window[\"__checkBudget__\"]();\n            return props.srcType === SrcType.Url;\n        },\n    },\n    autoplay: { type: framer_1.ControlType.Boolean, title: 'autoplay' },\n    controls: { type: framer_1.ControlType.Boolean, title: 'controls' },\n    loop: { type: framer_1.ControlType.Boolean, title: 'loop' },\n    muted: { type: framer_1.ControlType.Boolean, title: 'muted' },\n};\nexports.HTML_Video = HTML_Video;\nexports.__info__ = [{ name: \"HTML_Video\", children: false, type: \"component\" }];\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./code/HTML_Video.tsx\n");
...
module.exports = {"main":"dist/index.js","license":"MIT","devDependencies":{"@types/react":"^16.4.16"},"peerDependencies":{"framer":"^0.9.7 || ^0.10","react":"^16.3.0","react-dom":"^16.3.0"},"framer":{"id":"61f8a2f6-8b3c-40d1-9335-0ef94f50eee8","displayName":"HTML Video Player"},"author":". ruucm","dependencies":{"styled-components":"^4.1.3"},"name":"@framer/ruucm-h.html-video","version":"1.4.0"};
